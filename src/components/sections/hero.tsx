  ...
  return (
    <section id="home" className="scroll-section">
      <div className="z-10 container mx-auto flex h-full flex-col items-center justify-center text-center p-4">
        ...
        <GlitchText text="Pramesh Luitel" className="font-headline text-5xl md:text-6xl lg:text-8xl mb-4" />
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-8">
          <Button asChild size="lg" variant="outline" className="hover:bg-primary/90 hover:text-primary-foreground" onMouseEnter={playHoverSound}>
